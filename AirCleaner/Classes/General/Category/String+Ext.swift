...
extension String {
    ...
    func stringCut(end: Int) ->String{
        ...
        return startToEnd(start: 0, end: end)
    }
    ...
    func stringCutToEnd(star: Int) -> String {
        ...
        return startToEnd(start: star, end: count)
    }
    ...
    func stringEncoding() -> String {
        let url = self.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed) //urlQueryAllowed
        return url!
    }
}
