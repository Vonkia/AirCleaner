...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        CGFloat labelX = kPickerSize.width/(nameArr.count*2)+18+kPickerSize.width/nameArr.count*i + 20;
...
#pragma mark - Action
-(void)show {
    NSString *yearText = self.showYearView.text;
    self.showYearView.text = self.hiddenYearLabel ? @"" : yearText;
